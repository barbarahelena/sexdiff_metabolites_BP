...
df3 <- df2 %>% 
    mutate(
        ...
        met = as.factor(met),
        met = fct_recode(met, "sphingomyelin 38:3" = "SBPMale_1",
                         ...
                         "sphingomyelin 42:4" = "SBPMale_7",
                         "sphingomyelin 40:3" = "SBPMale_8",
